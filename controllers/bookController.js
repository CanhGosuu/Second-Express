...
exports.book_create_get = function(req, res) {
  ...
  async.parallel(
    ...
    function(err, results) {
      ...
      res.render("catalog/forms/book_form", {
        title: "Create Book",
...
exports.book_delete_get = function(req, res, next) {
  async.parallel(
    ...
    function(err, results) {
      ...
      // Successful, so render.
      res.render("catalog/deletes/book_delete", {
        title: "Delete Book",
        book: results.book,
...
exports.book_update_get = function(req, res, next) {
  ...
  async.parallel(
    ...
    function(err, results) {
      ...
      // Success.
      // Mark our selected genres as checked.
      for (var all_genre = 0; all_genre < results.genres.length; all_genre++) {
        for (
          var book_gener = 0;
          book_gener < results.book.genre.length;
          book_gener++
        ) {
          if (
            results.genres[all_genre]._id.toString() ==
            results.book.genre[book_gener]._id.toString()
          ) {
            results.genres[all_genre].checked = "true";
          }
        }
      }
      res.render("catalog/forms/book_form", {
